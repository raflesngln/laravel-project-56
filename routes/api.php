...
For adding data Method POST                 :  http://localhost:8000/api/v1/companies
...
Route::group(['prefix' => '/v1', 'namespace' => 'Api\V1', 'as' => 'api.'], function () {
    Route::resource('companies', 'CompaniesController', ['except' => ['create', 'edit']]); //kecuali fungsi create dan edit form
});
